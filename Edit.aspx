...
<body style="height: 324px" bgcolor="#a2cafb">
    ...
    <div style="height: 20px">
        ...
        <asp:Button ID="bHome" runat="server" onclick="bHome_Click" 
            style="z-index: 1; left: 314px; top: 34px; position: absolute" Text="Home" />
    
        <asp:Button ID="bSubmit" runat="server" onclick="bSubmit_Click" 
            style="z-index: 1; left: 178px; top: 41px; position: absolute; right: 520px" 
            Text="Submit" />
    ...
    .<asp:DropDownList ID="ddlName" runat="server" 
        style="z-index: 1; left: 77px; top: 35px; position: absolute">
    </asp:DropDownList>
    <p>
